...
`integrate` applies scVI integration to the filtered pooled object using `--batch_key` as the batch key, and `log1p_n_counts` and `percent_mito` as continuous covariates.
