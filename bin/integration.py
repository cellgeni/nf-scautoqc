...
cols_to_drop = ['latent_cell_probability', 'latent_RT_efficiency', 'cell_probability', 'droplet_efficiency', 'n_counts_raw', 'log1p_n_counts_raw', 'n_genes_raw', 'log1p_n_genes_raw', 'percent_mito_raw', 'n_counts_mito_raw', 'percent_ribo_raw', 'n_counts_ribo_raw', 'percent_hb_raw', 'n_counts_hb_raw', 'percent_top50_raw', 'n_counts_spliced', 'log1p_n_counts_spliced', 'n_genes_spliced', 'log1p_n_genes_spliced', 'percent_mito_spliced', 'n_counts_mito_spliced', 'percent_ribo_spliced', 'n_counts_ribo_spliced', 'percent_hb_spliced', 'n_counts_hb_spliced', 'percent_top50_spliced', 'n_counts_unspliced', 'log1p_n_counts_unspliced', 'n_genes_unspliced', 'log1p_n_genes_unspliced', 'percent_mito_unspliced', 'n_counts_mito_unspliced', 'percent_ribo_unspliced', 'n_counts_ribo_unspliced', 'percent_hb_unspliced', 'n_counts_hb_unspliced', 'percent_top50_unspliced', 'percent_soup', 'percent_spliced', 'qc_cluster', 'good_qc_cluster_mito20', 'pass_auto_filter_mito20', 'good_qc_cluster_mito50', 'pass_auto_filter_mito50', 'good_qc_cluster_mito80', 'pass_auto_filter_mito80', 'pass_auto_filter', 'good_qc_cluster', 'pass_default', 'cluster_scrublet_score', 'bh_pval', 'scrublet_score', 'scrublet_score_z', 'scrublet_done', 'doublet', 'stringent_doublet', '_scvi_batch', '_scvi_labels']

aux_ad.obs.drop(cols_to_drop, axis=1, inplace=True, errors='ignore')
